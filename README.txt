...
# NF_ampliseq 2.7.0
./nextflow run nf-core/ampliseq -r 2.7.0 -profile docker  --outdir ceshi --input_folder  /data/zhiyu/software/nfcore/V2.7.0/rawdata --FW_primer CCTACGGGNGGCWGCA --RV_primer GACTACHVGGGTATCTAAT
